...
class DailyState extends Equatable {
  ...
  static List<DailyState> perthle = [
    ...
    _dailyState(37, 'B$special', GameModeState.special),
    ...
    _dailyState(44, 'W$special', GameModeState.special),
    ...
    _dailyState(51, 'T$special', GameModeState.special),
    ...
    _dailyState(58, 'R$special', GameModeState.special),
    ...
    _dailyState(65, 'GR$special', GameModeState.special),
    ...
    _dailyState(72, 'L$special', GameModeState.special),
    ...
    _dailyState(79, 'S$special', GameModeState.special),
    ...
    _dailyState(86, 'K$special', GameModeState.special),
    ...
    _dailyState(93, 'G$special', GameModeState.special),
    ...
    _dailyState(113, 'CH$special', GameModeState.special),
    ...
    _dailyState(127, 'CITR$special', GameModeState.special),
    ...
    _dailyState(163, 'ALBAN$special', GameModeState.special),
    ...
    _dailyState(170, 'SHREK$special', GameModeState.special),
    ...
    _dailyState(177, 'BANKW$special', GameModeState.special),
    ...
    _dailyState(192, 'ANKHA', GameModeState.perthle),
    _dailyState(193, 'FLUENT', GameModeState.perthle),
    _dailyState(194, 'MARTO', GameModeState.perthle),
    _dailyState(195, 'COOPS', GameModeState.perthle),
    _dailyState(196, 'PERTH', GameModeState.perthle),
    _dailyState(197, 'TREEHOUSE', GameModeState.perthlonger),
    _dailyState(198, 'ATO', GameModeState.perthshorter),
  ];
